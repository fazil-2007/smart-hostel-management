...
const MOCK_DATA = {
  ...
  rooms: [
    { id: 1, roomNumber: 'A-101', blockName: 'Block A', floor: 1, capacity: 2, currentOccupancy: 2, roomType: 'STANDARD', status: 'FULL' },
    { id: 2, roomNumber: 'A-102', blockName: 'Block A', floor: 1, capacity: 2, currentOccupancy: 1, roomType: 'STANDARD', status: 'AVAILABLE' },
    { id: 3, roomNumber: 'B-201', blockName: 'Block B', floor: 2, capacity: 1, currentOccupancy: 0, roomType: 'DELUXE', status: 'AVAILABLE' },
    { id: 4, roomNumber: 'B-202', blockName: 'Block B', floor: 2, capacity: 2, currentOccupancy: 0, roomType: 'STANDARD', status: 'MAINTENANCE' },
    { id: 5, roomNumber: 'C-301', blockName: 'Block C', floor: 3, capacity: 3, currentOccupancy: 0, roomType: 'STANDARD', status: 'AVAILABLE' },
  ],
  allocations: [
    { id: 1, student: { id: 1, rollNumber: 'CS2024001', user: { fullName: 'Alex Mercer' } }, room: { roomNumber: 'A-101', blockName: 'Block A', floor: 1 }, allocationDate: '2025-08-01', status: 'ACTIVE' },
    { id: 2, student: { id: 2, rollNumber: 'EC2024045', user: { fullName: 'Sophia Chen' } }, room: { roomNumber: 'A-101', blockName: 'Block A', floor: 1 }, allocationDate: '2025-08-01', status: 'ACTIVE' },
    { id: 3, student: { id: 3, rollNumber: 'ME2024012', user: { fullName: 'Marcus Johnson' } }, room: { roomNumber: 'A-102', blockName: 'Block A', floor: 1 }, allocationDate: '2025-08-05', status: 'ACTIVE' },
  ],
  attendance: [
